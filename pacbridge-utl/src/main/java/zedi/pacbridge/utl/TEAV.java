 ...
 * </LI>
 * </UL>
 * <B>This is the extension, or variant, of TEA that addresses these concerns.</B>
 * <p/>
 * <P> Example of use:
 * <PRE>
...
public class TEAV {
    ...
    private static final String internalKey = "7d69df4d8fdac1dda0ff51861705b3b";
    ...
    public TEAV() {
        this(new BigInteger(internalKey, 16).toByteArray());
    }
     ...
     * @see #padding
     */
    protected int[] encode(byte b[], int count) {
        int j, i;
        int bLen = count;
        byte bp[] = b;
    ...
    public String encode(String text) {
        String tmpText = padPlaintext(text);
        int enc[] = encode(tmpText.getBytes(), tmpText.getBytes().length);
        return binToHex(enc);
    }
     ...
     */
    protected byte[] decode(byte b[], int count) {
        int i, j;
    ...
    public String decode(String encodedString) {
        return new String(decode(hexToBin(encodedString))).trim();
    }
     ...
     */
    protected int[] hexToBin(String hexStr) throws ArrayIndexOutOfBoundsException {
     ...
     */
    protected String binToHex(int enc[]) throws ArrayIndexOutOfBoundsException {
     ...
     */
    protected String padPlaintext(String str, char pc) {
     ...
     * @param str Plain text string.
     */
    protected String padPlaintext(String str) {
