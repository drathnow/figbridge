...
public class ConsoleTextPane extends JTextPane {
    ...
    protected final static int MAX_LENGTH = 80000;
    ...
    private class PopupMenu extends JPopupMenu {
        JMenuItem copyMenuItem = new CopyMenuItem();
        public PopupMenu() {
            add(copyMenuItem);
            add(new SelectAllMenuItem());
    ...
    private class PopupMenuListener extends MouseAdapter {
        ...
        public PopupMenuListener(PopupMenu popupMenu) {
        ...
        public void mouseReleased(MouseEvent e) {
            if (e.isPopupTrigger()) {
                popupMenu.validate();
                popupMenu.copyMenuItem.validate();
