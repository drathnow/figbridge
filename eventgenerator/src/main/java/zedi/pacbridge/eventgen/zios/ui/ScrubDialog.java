...
public class ScrubDialog extends JDialog {
    ...
    @Inject
    public ScrubDialog(StaticEventGenerator eventGenerator) {
        this();
    ...
    public ScrubDialog() {
        ...
        sendButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                eventGenerator.publishScrubEvent(ioPointsCheckBox.isSelected(), eventsCheckBox.isSelected(), reportCheckBox.isSelected(), allCheckBox.isSelected());
            }
        });
