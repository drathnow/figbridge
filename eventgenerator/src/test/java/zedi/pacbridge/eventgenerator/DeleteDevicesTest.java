...
public class DeleteDevicesTest extends ConfigureBaseTest {
    
    @Test
    public void shouldHandleSuccessfulDelete() throws Exception {
        testSuccessfulUpdateDeleteAction(deleteFields(), ActionType.DELETE, ObjectType.DEVICE);
    }
    
    @Test
    public void shouldHandleMissingId() throws Exception {
        testForMissingField("Id", deleteFields(), ActionType.DELETE, ObjectType.DEVICE);
    }
