...
public class DeleteSitesTest extends ConfigureBaseTest {
    
    @Test
    public void shouldHandleSuccessfulDelete() throws Exception {
        testSuccessfulUpdateDeleteAction(deleteFields(), ActionType.DELETE, ObjectType.SITE);
    }
    
    @Test
    public void shouldHandleMissingId() throws Exception {
        testForMissingField("Id", deleteFields(), ActionType.DELETE, ObjectType.SITE);
    }
