...
public class DeleteIoPointsTest extends ConfigureBaseTest {
    
    @Test
    public void shouldHandleSuccessfulDelete() throws Exception {
        testSuccessfulUpdateDeleteAction(deleteFields(), ActionType.DELETE, ObjectType.IO_POINT);
    }
    
    @Test
    public void shouldHandleMissingId() throws Exception {
        testForMissingField("Id", deleteFields(), ActionType.DELETE, ObjectType.IO_POINT);
    }
