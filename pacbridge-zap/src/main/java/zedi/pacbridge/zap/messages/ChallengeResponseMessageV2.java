...
public class ChallengeResponseMessageV2 extends ZapMessage implements ChallengeResponseMessage {
    ...
    public ChallengeResponseMessageV2(EncryptionType encryptionType, CompressionType compressionType, Integer deviceTime, byte[] clientSalt, byte[] clientHash, String username, String firmwareVersion) {
        super(ZapMessageType.ChallengeResponseV2);
    ...
    public static ChallengeResponseMessageV2 clientChallengeResponseFromByteBuffer(ByteBuffer byteBuffer) {
        byteBuffer.get(); // Size
        ...
        foo = new byte[(int)byteBuffer.get()];
        byteBuffer.get(foo);
        String firmwareVersion = new String(foo, Charset.forName("US-ASCII"));
        return new ChallengeResponseMessageV2(encryptionType, compressionType, deviceTime, clientSalt, clientHash, username, firmwareVersion);
    }
